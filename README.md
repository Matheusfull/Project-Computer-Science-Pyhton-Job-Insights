...
<details>
  ...
  Neste projeto eu implementei análises a partir de um conjunto de dados sobre empregos. Essas implementações são incorporadas a um aplicativo Web desenvolvido com Flask (um framework web muito popular na comunidade Python). Além disso, tive a oportunidade de escrever testes para a implementação de uma análise de dados.
